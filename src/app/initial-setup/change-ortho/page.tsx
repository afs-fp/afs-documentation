...
const ChangeOrtho: NextPage = () => {
  ...
  const Layer: CardData2[] = [
    {
      gifUrl: `${baseURL}/img/initial-setup/change-ortho/c-o-1.png`,
      number: '01',
      title: 'Step 1',
      description: `
      `,
    ...
    {
      gifUrl: `${baseURL}/img/initial-setup/change-ortho/c-o-2.png`,
      number: '02',
      title: 'Step 2',
      description: `
      `,
    ...
    {
      gifUrl: `${baseURL}/img/initial-setup/change-ortho/c-o-3.png`,
      number: '03',
      title: 'Step 3',
      description: `
      `,
    ...
    <div className="flex w-full flex-col items-center">
      <div className="p-8">
        <main className="rounded-lg p-6">
          <h1 className="border-b pb-2 text-4xl font-bold">Change Ortho</h1>

          <h2
            id="layer-properties"
            className="mt-8 border-b text-2xl font-semibold"
          >
            Follow these steps to change your orthogonal bind
          </h2>
